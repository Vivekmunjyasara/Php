            ...
            <div class="row">
                <div class="col-lg-5 late">
                    <ul>
                        ...
                        <li class="mb"><h4>Creative Thinking</h4></li>
            ...
            <div class="row">
                <div class="col-lg-4 late">
                    ...
                    <ol type="I" class="fw-bold font">
                        ...
                        <br>
                        <li style="margin-left: 5%;"><h4>I also added basic <b>Form animation</b> and improved user experience through <b>structured layout and responsive design</b></h4></li>
                        <br>
